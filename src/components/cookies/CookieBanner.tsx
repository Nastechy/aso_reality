...
export default function CookieBannerUBA({
      ...
      <div className="mx-auto w-full max-w-7xl px-4 md:px-6 py-5">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-end gap-2">
          ...
          <button
            ...
            className="h-10 rounded border cursor-pointer border-neutral-300 hover:bg-neutral-100 text-neutral-900 text-sm px-4"
          >
            Reject All
          </button>
          ...
          <button
            ...
            className="h-10 rounded cursor-pointer bg-[#902923] hover:bg-[#08194A] text-white text-sm px-4"
          >
            Accept All
          </button>
        </div>
